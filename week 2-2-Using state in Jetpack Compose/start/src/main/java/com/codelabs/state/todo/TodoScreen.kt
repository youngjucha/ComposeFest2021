...
@Composable
private fun TodoInputTextField(text: String, onTextChange: (String) -> Unit, modifier: Modifier) {
...
fun TodoItemInput(onItemComplete: (TodoItem) -> Unit) {
    //onItemComplete는 이벤트로서 사용자에 의해 아이템이 완료될 때 호출.
    ...
    Column {
        Row(
            ...
            TodoEditButton(
                ...
                enabled = text.isNotBlank() // 텍스트가 비어있지 않을 때 활성화
            )
        }
        if (iconsVisible) {
